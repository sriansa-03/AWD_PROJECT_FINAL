...
<section class="commercial-asd container">
    ...
    <input class="kolo" type="text" name="ProTitle" placeholder="Title" alt="waiting"title="Pleaes write Your Title" value="<?php ECHO $row['Title']; ?>"  >
    ...
    <input class="kolo" type="text" name="Proprice" placeholder="price" alt="waiting"title="Pleaes write Your price" value="<?php ECHO $row['Price']; ?>"  >
